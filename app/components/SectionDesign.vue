  ...
  >
    ...
    <div class="col-span-1 md:col-span-2 md:sticky md:top-28 flex flex-col gap-6">
      <div class="grid grid-cols-3 gap-[15px]">
        ...
        <!-- <div class="hidden col-span-1 bg-box-grey h-[120px] w-full hidden md:block mt-4 rounded-sm"></div>
         -->
        
        <!-- <div class="hidden col-span-1 bg-box-grey h-[280px] w-full hidden md:block mt-4 rounded-sm"></div> -->
      </div>
    </div>
